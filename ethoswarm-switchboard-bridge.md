...
```
POST https://extractor-XXXXX.sprites.example/intake
...
```
POST https://extractor-XXXXX.sprites.example/intake/structured
Content-Type: application/json
...
```json
{
  ...
  "endpoint": "https://extractor-XXXXX.sprites.example/intake/structured",
  "input_schema": {
...
```json
{
  ...
  "endpoint": "https://extractor-XXXXX.sprites.example/search",
  "input": {
    "query": "string",
