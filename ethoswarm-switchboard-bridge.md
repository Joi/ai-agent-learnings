...
```
POST https://intake-XXXXX.sprites.example/intake
...
```
POST https://intake-XXXXX.sprites.example/intake/structured
Content-Type: application/json
...
```json
{
  ...
  "endpoint": "https://intake-XXXXX.sprites.example/intake/structured",
  "input_schema": {
...
```json
{
  ...
  "endpoint": "https://intake-XXXXX.sprites.example/search",
  "input": {
    "query": "string",
